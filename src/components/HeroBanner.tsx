  ...
  return (
    <div className={styles.banner}>
      ...
      <div className={`container ${styles.inner}`}>
        {/* Тот же утверждённый SVG-логотип, что и в шапке личного кабинета
            (см. Header.tsx) — вместо плоской буквы "H"-заглушки. ID
            градиентов здесь СВОИ (hmHero*), не hmLogo* — на этой публичной
            странице Header.tsx вообще не рендерится (см. app/page.tsx,
            здесь свой баннер), но ID в SVG уникальны на весь документ, а не
            только внутри своего <svg>, так что отдельный префикс — на
            случай, если оба компонента когда-нибудь окажутся на одной
            странице одновременно. Анимация вращения мяча при наведении —
            тот же приём, что и в Header.module.css (.logoBallSpin вложена
            В .logoBallGroup, а не заменяет её transform напрямую, см.
            подробное объяснение там же). */}
        <div className={styles.logo}>
          <svg className={styles.logoMark} viewBox="0 0 300 300" width="48" height="48" aria-hidden="true">
            ...
            <g className={styles.logoBallGroup} transform="translate(95,59) scale(0.2444)">
              <g className={styles.logoBallSpin}>
                <defs>
                  <linearGradient id="hmHeroA3">
                    <stop offset="0" />
                    <stop stopOpacity="0" offset="1" />
                  </linearGradient>
                  <linearGradient id="hmHeroF3" x1=".23348" x2=".37601" y1=".35517" y2="-.47343">
                    <stop stopColor="#333" offset="0" />
                    <stop stopOpacity="0" offset="1" />
                  </linearGradient>
                  <linearGradient id="hmHeroE3" x1="1.0197" x2=".13875" y1=".42728" y2=".14519" xlinkHref="#hmHeroA3" />
                  <linearGradient id="hmHeroD3" x1=".11003" x2="1.0193" y1=".35019" y2=".49577" xlinkHref="#hmHeroA3" />
                  <radialGradient id="hmHeroC3" cx="478.61" cy="550.29" r="225.06" gradientUnits="userSpaceOnUse">
                    <stop stopColor="#fff" offset="0" />
                    <stop stopColor="#fff" offset=".4702" />
                    <stop stopColor="#d6d6d6" offset="1" />
                  </radialGradient>
                  <radialGradient id="hmHeroB3" cx="477.49" cy="544.3" r="206.09" gradientUnits="userSpaceOnUse">
