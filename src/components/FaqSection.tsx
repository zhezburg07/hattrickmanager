...
const FAQ_ITEMS: { question: string; answer: React.ReactNode }[] = [
  ...
  },
  {
    ...
    answer:
      "Проект родился где-то на границах Центральной Азии — там, где степь встречается с интернетом, а искренняя любовь к футбольному менеджменту однажды переросла в желание сделать что-то полезное для всего сообщества Hattrick.",
  },
  {
