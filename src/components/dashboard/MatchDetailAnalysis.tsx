...
// поведение снова станет нестабильным по конкретным матчам. Выключено (см.
// чат "Диагностика на вкладке Матчи видна на проде") — обычные пользователи
// не должны видеть эту панель на боевом сайте. Код не удалён — вернуть
// можно одной строкой, если снова понадобится диагностировать.
const SHOW_MATCH_ANALYSIS_DEBUG = false;
