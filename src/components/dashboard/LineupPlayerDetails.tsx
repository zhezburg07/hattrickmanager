    ...
    <div className={styles.card}>
      ...
      {!player ? (
        <p className={styles.hint} style={{ margin: 0 }}>
          Нажмите на игрока в запасе или в общем списке ниже, чтобы увидеть его форму, выносливость и скиллы —
          показатели игрока на поле открываются рядом с ним самим.
        </p>
      ) : (
        <>
