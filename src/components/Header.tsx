    ...
    <header className={styles.header}>
      <div className={`container ${styles.inner}`}>
        {/* Внутри личного кабинета логотип ведёт на /dashboard, а не на
            ...
            входа). */}
        {/* Новый логотип (по запросу, см. чат "Логотип шапки") — вместо
            текста "HattrickManager" и плоского квадрата "H": реалистичный
            мяч (тот же graphics, что и в меню личного кабинета, см.
            .menuBallButton выше — ID градиентов здесь ДРУГИЕ, hmLogoBall*,
            чтобы не конфликтовать с одноимёнными в SVG кнопки-мяча: оба
            элемента одновременно на странице внутри личного кабинета, а
            id в SVG уникальны на весь документ, не только внутри своего
            <svg>) в круглой золотой рамке, мини-значок "A" (Assistant)
            в углу и сокращённая надпись "Hm" рядом. Мяч крутится ТОЛЬКО
            при наведении на весь логотип (.logo:hover), сама анимация
            (@keyframes logoBallSpin) применена именно к .logoBall, а не к
            рамке/значку/тексту — они собственных transform/animation не
            получают и остаются неподвижными. */}
        <Link
        ...
        >
          <span className={styles.logoMark}>
            <svg className={styles.logoBall} viewBox="0 0 450 483" aria-hidden="true">
              <defs>
                <radialGradient id="hmLogoBallBody" cx="478.61" cy="550.29" r="225.06" gradientUnits="userSpaceOnUse">
                  <stop stopColor="#fff" offset="0" />
                  <stop stopColor="#fff" offset=".4702" />
                  <stop stopColor="#d6d6d6" offset="1" />
                </radialGradient>
                <radialGradient id="hmLogoBallShadow" cx="477.49" cy="544.3" r="206.09" gradientUnits="userSpaceOnUse">
              ...
              <path
                ...
                fill="url(#hmLogoBallBody)"
                fillRule="evenodd"
              />
            </svg>
            <span className={styles.logoBadgeA} aria-hidden="true">
              A
            </span>
          </span>
