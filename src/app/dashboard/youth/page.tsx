...
// вернул пусто". Выключено (см. чат "Диагностика на вкладке Матчи видна на
// проде") — список уже стабильно показывает реальных игроков академии
// (см. диагностику из чата "Срочная регрессия: юношеская академия ошибочно
// показана как отсутствующая" — HTTP 200, 15 игроков), панель была случайно
// оставлена включённой и видна обычным пользователям. Код не удалён —
// вернуть можно одной строкой, если снова понадобится диагностировать.
const SHOW_YOUTH_DEBUG_PANEL = false;
