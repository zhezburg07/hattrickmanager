...
// вместо того чтобы гадать перевод. "KZT" — международное сокращение, а не
// полное слово "тенге", по явному запросу пользователя (см. чат "Кубки/
// Юношеская команда/Трансферы: диагностика") — единый label используется
// везде (Финансы/Стадион/Трансферы), см. defaultCurrency в data/dashboard.ts.
